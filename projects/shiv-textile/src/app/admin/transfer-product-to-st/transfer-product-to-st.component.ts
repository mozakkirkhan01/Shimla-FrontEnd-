...
@Component({
  selector: 'app-transfer-product-to-st',
  templateUrl: './transfer-product-to-st.component.html',
  styleUrls: ['./transfer-product-to-st.component.css']
})
export class TransferProductToSTComponent implements OnInit {
  Transfer: any = {};
  employeeDetail: any;
  ...
  afterProductStockSelected(item: any) {
    ...
    this.changeSellingPrice(this.TransferProduct);
  }
